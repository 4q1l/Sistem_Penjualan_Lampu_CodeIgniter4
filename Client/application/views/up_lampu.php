...
<body>
    ...
    <?php foreach($tampil->lampu as $result) { ?>
    ...
    <main class="area-grid">
        ...
        <section class="item-input1">
            <input type="text" id="txt_kode" class="text-input" maxlength="9" value="<?php echo $result->kode_lampu; ?>">
        </section>
        ...
        <section class="item-input4">
            <select id="cbo_tegangan" class="text-input">
    ...
    <script>
        ...
        const setUpdate = (kode, nama, harga, tegangan,token) => {
            ...
            fetch('<?php echo site_url("Lampu/setUpdate"); ?>', {
                    method: "POST",
                    body: form
                })
